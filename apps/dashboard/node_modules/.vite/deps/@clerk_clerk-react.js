...
function createErrorTypeGuard(ErrorClass) {
  function typeGuard(error) {
    ...
    if (ErrorClass.kind && typeof target === "object" && target !== null && "constructor" in target) {
      if (((_a5 = target.constructor) == null ? void 0 : _a5.kind) === ErrorClass.kind)
        return true;
    }
...
var checkOrgAuthorization = (params, options) => {
  ...
  if (roleAsked) {
    if (typeof orgRole !== "string" || !orgRole)
      return "fail";
    if (prefixWithOrg(orgRole) !== prefixWithOrg(params.role))
      return "fail";
  }
  if (permissionAsked) {
    if (!Array.isArray(orgPermissions))
      return "fail";
    if (!orgPermissions.includes(prefixWithOrg(params.permission)))
      return "fail";
  }
  return "pass";
};
...
var checkBillingAuthorization = (params, options) => {
  ...
  if (featureAsked) {
    if (typeof features !== "string" || !features)
      return "fail";
    try {
      if (!checkForFeatureOrPlan(features, params.feature))
        return "fail";
    } catch {
      return "fail";
    }
  ...
  if (planAsked) {
    if (typeof plans !== "string" || !plans)
      return "fail";
    try {
      if (!checkForFeatureOrPlan(plans, params.plan))
        return "fail";
    } catch {
      return "fail";
    }
...
var checkReverificationAuthorization = (params, { factorVerificationAge }) => {
  if (params.reverification === void 0)
    return "skip";
  if (!factorVerificationAge)
    return "fail";
  if (!Array.isArray(factorVerificationAge) || factorVerificationAge.length !== 2 || !isValidFactorAge(factorVerificationAge[0]) || !isValidFactorAge(factorVerificationAge[1]))
    return "fail";
...
var PaymentElementInternalRoot = (props) => {
  ...
  if (stripe && externalClientSecret)
    return import_react6.default.createElement(Elements, {
...
// node_modules/@clerk/shared/dist/runtime/versionSelector-WwgMlSnS.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.128.0") => {
  if (clerkJSVersion)
...
// node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-DJD6I324.mjs
